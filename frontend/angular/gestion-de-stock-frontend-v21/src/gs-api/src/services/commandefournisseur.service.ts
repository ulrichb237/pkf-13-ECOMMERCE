...
class CommandefournisseurService extends __BaseService {
  static readonly findAllPath = '/api/v1/commandes-fournisseurs';
  static readonly savePath = '/api/v1/commandes-fournisseurs';
  static readonly deleteArticlePath = '/api/v1/commandes-fournisseurs/{idCommande}/lignes/{idLigneCommande}';
  static readonly deletePath = '/api/v1/commandes-fournisseurs/{idCommandeFournisseur}';
  static readonly findByCodePath = '/api/v1/commandes-fournisseurs/code/{codeCommandeFournisseur}';
  static readonly findAllLignesCommandesFournisseurByCommandeFournisseurIdPath = '/api/v1/commandes-fournisseurs/{idCommande}/lignes';
  static readonly updateArticlePath = '/api/v1/commandes-fournisseurs/{idCommande}/lignes/{idLigneCommande}/article/{idArticle}';
  static readonly updateEtatCommandePath = '/api/v1/commandes-fournisseurs/{idCommande}/etat/{etatCommande}';
  static readonly updateFournisseurPath = '/api/v1/commandes-fournisseurs/{idCommande}/fournisseur/{idFournisseur}';
  static readonly updateQuantiteCommandePath = '/api/v1/commandes-fournisseurs/{idCommande}/lignes/{idLigneCommande}/quantite/{quantite}';
  static readonly findByIdPath = '/api/v1/commandes-fournisseurs/{idCommandeFournisseur}';
  ...
  findAllResponse(): __Observable<__StrictHttpResponse<Array<CommandeFournisseurDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/v1/commandes-fournisseurs`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteArticleResponse(params: CommandefournisseurService.DeleteArticleParams): __Observable<__StrictHttpResponse<CommandeFournisseurDto>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/api/v1/commandes-fournisseurs/${params.idCommande}/lignes/${params.idLigneCommande}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteResponse(idCommandeFournisseur: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/api/v1/commandes-fournisseurs/${idCommandeFournisseur}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByCodeResponse(codeCommandeFournisseur: string): __Observable<__StrictHttpResponse<CommandeFournisseurDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/v1/commandes-fournisseurs/code/${codeCommandeFournisseur}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findAllLignesCommandesFournisseurByCommandeFournisseurIdResponse(idCommande: number): __Observable<__StrictHttpResponse<Array<LigneCommandeFournisseurDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/v1/commandes-fournisseurs/${idCommande}/lignes`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  updateArticleResponse(params: CommandefournisseurService.UpdateArticleParams): __Observable<__StrictHttpResponse<CommandeFournisseurDto>> {
    ...
    let req = new HttpRequest<any>(
      'PATCH',
      this.rootUrl + `/api/v1/commandes-fournisseurs/${params.idCommande}/lignes/${params.idLigneCommande}/article/${params.idArticle}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  updateEtatCommandeResponse(params: CommandefournisseurService.UpdateEtatCommandeParams): __Observable<__StrictHttpResponse<CommandeFournisseurDto>> {
    ...
    let req = new HttpRequest<any>(
      'PATCH',
      this.rootUrl + `/api/v1/commandes-fournisseurs/${params.idCommande}/etat/${params.etatCommande}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  updateFournisseurResponse(params: CommandefournisseurService.UpdateFournisseurParams): __Observable<__StrictHttpResponse<CommandeFournisseurDto>> {
    ...
    let req = new HttpRequest<any>(
      'PATCH',
      this.rootUrl + `/api/v1/commandes-fournisseurs/${params.idCommande}/fournisseur/${params.idFournisseur}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  updateQuantiteCommandeResponse(params: CommandefournisseurService.UpdateQuantiteCommandeParams): __Observable<__StrictHttpResponse<CommandeFournisseurDto>> {
    ...
    let req = new HttpRequest<any>(
      'PATCH',
      this.rootUrl + `/api/v1/commandes-fournisseurs/${params.idCommande}/lignes/${params.idLigneCommande}/quantite/${params.quantite}`,
      __body,
      {
        headers: __headers,
        params: __params,
