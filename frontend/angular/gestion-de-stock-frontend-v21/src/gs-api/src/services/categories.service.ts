...
class CategoriesService extends __BaseService {
  static readonly findAllPath = '/api/v1/categories';
  static readonly savePath = '/api/v1/categories';
  static readonly deletePath = '/api/v1/categories/{idCategory}';
  static readonly findByCodePath = '/api/v1/categories/code/{codeCategory}';
  static readonly findByIdPath = '/api/v1/categories/{idCategory}';
  ...
  deleteResponse(idCategory: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/api/v1/categories/${idCategory}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByCodeResponse(codeCategory: string): __Observable<__StrictHttpResponse<CategoryDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/v1/categories/code/${codeCategory}`,
      __body,
      {
        headers: __headers,
        params: __params,
