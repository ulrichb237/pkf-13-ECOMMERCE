...
class UtilisateursService extends __BaseService {
  static readonly findAllPath = '/api/v1/utilisateurs';
  static readonly savePath = '/api/v1/utilisateurs';
  static readonly deletePath = '/api/v1/utilisateurs/{idUtilisateur}';
  static readonly findByEmailPath = '/api/v1/utilisateurs/email/{email}';
  static readonly changerMotDePassePath = '/api/v1/utilisateurs/mot-de-passe';
  static readonly findByIdPath = '/api/v1/utilisateurs/{idUtilisateur}';
  ...
  findAllResponse(): __Observable<__StrictHttpResponse<Array<UtilisateurDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/v1/utilisateurs`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteResponse(idUtilisateur: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/api/v1/utilisateurs/${idUtilisateur}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByEmailResponse(email: string): __Observable<__StrictHttpResponse<UtilisateurDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/v1/utilisateurs/email/${email}`,
      __body,
      {
        headers: __headers,
        params: __params,
