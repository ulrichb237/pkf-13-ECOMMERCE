...
class VentesService extends __BaseService {
  static readonly findAllPath = '/api/v1/ventes';
  static readonly savePath = '/api/v1/ventes';
  static readonly deletePath = '/api/v1/ventes/{idVente}';
  static readonly findByCodePath = '/api/v1/ventes/code/{codeVente}';
  static readonly findByIdPath = '/api/v1/ventes/{idVente}';
  ...
  deleteResponse(idVente: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/api/v1/ventes/${idVente}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByCodeResponse(codeVente: string): __Observable<__StrictHttpResponse<VentesDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/v1/ventes/code/${codeVente}`,
      __body,
      {
        headers: __headers,
        params: __params,
