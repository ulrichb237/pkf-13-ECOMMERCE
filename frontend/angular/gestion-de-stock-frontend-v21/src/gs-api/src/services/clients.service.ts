...
class ClientsService extends __BaseService {
  static readonly findAllPath = '/api/v1/clients';
  static readonly savePath = '/api/v1/clients';
  static readonly deletePath = '/api/v1/clients/{idClient}';
  static readonly findByIdPath = '/api/v1/clients/{idClient}';
  ...
  deleteResponse(idClient: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/api/v1/clients/${idClient}`,
      __body,
      {
        headers: __headers,
        params: __params,
