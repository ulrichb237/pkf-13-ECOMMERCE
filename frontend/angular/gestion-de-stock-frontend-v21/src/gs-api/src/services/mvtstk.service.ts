...
class MvtstkService extends __BaseService {
  static readonly correctionStockNegPath = '/api/v1/mouvements-stock/correction-negative';
  static readonly correctionStockPosPath = '/api/v1/mouvements-stock/correction-positive';
  static readonly entreeStockPath = '/api/v1/mouvements-stock/entree';
  static readonly mvtStkArticlePath = '/api/v1/mouvements-stock/articles/{idArticle}';
  static readonly sortieStockPath = '/api/v1/mouvements-stock/sortie';
  static readonly stockReelArticlePath = '/api/v1/mouvements-stock/articles/{idArticle}/stock-reel';
  ...
  correctionStockNegResponse(body?: MvtStkDto): __Observable<__StrictHttpResponse<MvtStkDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/api/v1/mouvements-stock/correction-negative`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  correctionStockPosResponse(body?: MvtStkDto): __Observable<__StrictHttpResponse<MvtStkDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/api/v1/mouvements-stock/correction-positive`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  entreeStockResponse(body?: MvtStkDto): __Observable<__StrictHttpResponse<MvtStkDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/api/v1/mouvements-stock/entree`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  mvtStkArticleResponse(idArticle: number): __Observable<__StrictHttpResponse<Array<MvtStkDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/v1/mouvements-stock/articles/${idArticle}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  sortieStockResponse(body?: MvtStkDto): __Observable<__StrictHttpResponse<MvtStkDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/api/v1/mouvements-stock/sortie`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  stockReelArticleResponse(idArticle: number): __Observable<__StrictHttpResponse<number>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/v1/mouvements-stock/articles/${idArticle}/stock-reel`,
      __body,
      {
        headers: __headers,
        params: __params,
