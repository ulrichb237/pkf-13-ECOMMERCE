...
class ArticlesService extends __BaseService {
  static readonly findAllPath = '/api/v1/articles';
  static readonly savePath = '/api/v1/articles';
  static readonly deletePath = '/api/v1/articles/{idArticle}';
  static readonly findAllArticleByIdCategoryPath = '/api/v1/categories/{idCategory}/articles';
  static readonly findByCodeArticlePath = '/api/v1/articles/code/{codeArticle}';
  static readonly findHistoriaueCommandeClientPath = '/api/v1/articles/{idArticle}/historique-commandes-clients';
  static readonly findHistoriqueCommandeFournisseurPath = '/api/v1/articles/{idArticle}/historique-commandes-fournisseurs';
  static readonly findHistoriqueVentesPath = '/api/v1/articles/{idArticle}/historique-ventes';
  static readonly findByIdPath = '/api/v1/articles/{idArticle}';
  ...
  deleteResponse(idArticle: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/api/v1/articles/${idArticle}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findAllArticleByIdCategoryResponse(idCategory: number): __Observable<__StrictHttpResponse<Array<ArticleDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/v1/categories/${idCategory}/articles`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByCodeArticleResponse(codeArticle: string): __Observable<__StrictHttpResponse<ArticleDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/v1/articles/code/${codeArticle}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findHistoriaueCommandeClientResponse(idArticle: number): __Observable<__StrictHttpResponse<Array<LigneCommandeClientDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/v1/articles/${idArticle}/historique-commandes-clients`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findHistoriqueCommandeFournisseurResponse(idArticle: number): __Observable<__StrictHttpResponse<Array<LigneCommandeFournisseurDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/v1/articles/${idArticle}/historique-commandes-fournisseurs`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findHistoriqueVentesResponse(idArticle: number): __Observable<__StrictHttpResponse<Array<LigneVenteDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/v1/articles/${idArticle}/historique-ventes`,
      __body,
      {
        headers: __headers,
        params: __params,
