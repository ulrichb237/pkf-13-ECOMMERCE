...
class FournisseurService extends __BaseService {
  static readonly findAllPath = '/api/v1/fournisseurs';
  static readonly savePath = '/api/v1/fournisseurs';
  static readonly deletePath = '/api/v1/fournisseurs/{idFournisseur}';
  static readonly findByIdPath = '/api/v1/fournisseurs/{idFournisseur}';
  ...
  findAllResponse(): __Observable<__StrictHttpResponse<Array<FournisseurDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/v1/fournisseurs`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteResponse(idFournisseur: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/api/v1/fournisseurs/${idFournisseur}`,
      __body,
      {
        headers: __headers,
        params: __params,
