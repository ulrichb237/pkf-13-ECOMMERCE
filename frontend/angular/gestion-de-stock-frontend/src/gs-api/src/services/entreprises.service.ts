...
class EntreprisesService extends __BaseService {
  static readonly findAllPath = '/api/v1/entreprises';
  static readonly savePath = '/api/v1/entreprises';
  static readonly deletePath = '/api/v1/entreprises/{idEntreprise}';
  static readonly findByIdPath = '/api/v1/entreprises/{idEntreprise}';
  ...
  findAllResponse(): __Observable<__StrictHttpResponse<Array<EntrepriseDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/v1/entreprises`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteResponse(idEntreprise: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/api/v1/entreprises/${idEntreprise}`,
      __body,
      {
        headers: __headers,
        params: __params,
